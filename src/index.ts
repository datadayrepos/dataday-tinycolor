...
import type { HSL, HSLA, HSV, HSVA, Numberify, RGB, RGBA } from './interfaces'
...
export class TinyColor {
  ...
  toHsv(): Numberify<HSVA> {
    ...
    return { a: this.a, h: hsv.h * 360, s: hsv.s, v: hsv.v }
  }
  ...
  toHsl(): Numberify<HSLA> {
    ...
    return { a: this.a, h: hsl.h * 360, l: hsl.l, s: hsl.s }
  }
  ...
  splitcomplement(): TinyColor[] {
    ...
    return [
      this,
      new TinyColor({ h: (h + 72) % 360, l: hsl.l, s: hsl.s }),
      new TinyColor({ h: (h + 216) % 360, l: hsl.l, s: hsl.s }),
    ]
  }
